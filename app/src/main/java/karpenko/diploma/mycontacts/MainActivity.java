...
import karpenko.diploma.mycontacts.databinding.ActivityMainBinding;
...
*/
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (TextUtils.isEmpty(firstNameEditText.getText().toString())){
                                    ...
                                    Toast.makeText(MainActivity.this, "Enter Lastnam", Toast.LENGTH_SHORT).show();
    ...
    private void updateContact(String firsName, String lastName
    ...
    private void addContact(String firsName, String lastName
            , String email, String phoneNumber){

        Contact contact = new Contact(
                0, firsName, lastName, email, phoneNumber
        );
   ...
   /* @Override
    ...
    private class GetAllContactsAsyncTask extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            contactsArrayList = (ArrayList<Contact>) myContactsDatabase.getContactDao().getAllContacts();
